...
import Reklama1 from "../components/Presentation/Reklama1";
    ...
    <ScrollView>
      ...
      <View style={styles.wrapper}>
        <Text style={styles.title}>
          Sporne pošiljke: Nakon Hrvatske, i Srbija vratila voće iz Malezije
        </Text>
        ...
        <Text style={styles.subTitle}>
          Vojna administracija Gabona otvorila je kopnene, morske i zračne
          granice nakon izvršenog..{" "}
        </Text>
        ...
        <Text style={styles.text}>
          {" "}
          Tokom 2025. godine planirana je njegova izgradnja, a s radom bi trebao
          početi 2026. godine. Bh. strana tvrdi da će iskoristiti sve pravne
          alate kako bi spriječila Hrvatsku u njenim namjerama. Tokom 2025.
          godine planirana je njegova izgradnja, a s radom bi trebao početi
          2026. godine. Bh. strana tvrdi da će iskoristiti sve pravne alate kako
          bi spriječila Hrvatsku u njenim namjerama.
        </Text>
        ...
        <Text style={styles.text}>
          {" "}
          Slike Milorada Dodika, Vladimira Putina, majice plaćenićke
          organizacije Wagner, snajperisti MUP-a RS-a sa zgrada, parole i
          natpisi 'Granice postoje', skandiranje imena ratnog zločinca...
        </Text>
