  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => handleFacebookPress(URL)}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconWrapper}
        onPress={() => handleTwitterPress(URL)}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconWrapper}
        onPress={() => handleWhatsAppPress(URL)}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconWrapper}
        onPress={() => handleMessengerPress(URL)}
      >
        <Image
